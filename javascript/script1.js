...
// Audio variables
const audioDice = new Audio('Audio/hold.ogg');
const audioHold = new Audio('Audio/dicethrow.wav');
const audioLost = new Audio('Audio/');
const audioWin = new Audio('Audio/win.flac');
const audioNew = new Audio('Audio/doll.wav');
...
function setMainStyle(id) {
    players[id].main.style.boxShadow = '0px 0px 15px #fffff';
    if (id === 1) {
